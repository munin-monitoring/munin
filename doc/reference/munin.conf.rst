...
.. option:: graph_strategy cron

   In Munin stable 2.0 graphics files are generated either via cron or by a CGI process.
   See `Dynamic generation of munin graphs and html <http://munin-monitoring.org/wiki/MuninConfigurationMasterCGI>`_
   in the wiki for more documentation. Since 2.0, munin-graph has been rewritten to use the cgi code.
