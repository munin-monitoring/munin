...
function prepareModal(modalId, modalHTMLContent) {
	...
	body.append('<div class="modal" data-modalname="' + modalId + '" style="display: none;">'
					...
					+ '    <span></span>'
					+ '    <a href="#close" class="action close"><i class="mdi mdi-window-close"></i></a>'
					+ '    <a href="#" class="action open" id="modal' + modalId + '-open" style="display: none;"><i class="mdi mdi-open-in-new"></i></a>'
					+ '</div>'
					+ modalHTMLContent
				+ '</div>');
